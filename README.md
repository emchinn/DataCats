...
### neurCombat
A statistical tool to remove unwanted sources of MRI scan variability, from this [repo](https://github.com/Jfortin1/neuroCombat) and described in this [paper](https://www.sciencedirect.com/science/article/abs/pii/S105381191730931X). Non-biological variance can be introduced by differences in MRI scanners and acquisition protocols, this tool is meant to correct for batch effects. 
